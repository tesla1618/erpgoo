...
@push('script-page')
    ...
    <script>
        var options = {
            ...
            series: [{
                name: 'Paid',
                data: [{{$totPaidAgent}}, {{$totPaidVendor}}, {{$totPaidClient}}]
            }, {
                name: 'Due',
                data: [{{$totDueAgent}}, {{$totDueVendor}}, {{$totDueClient}}]
            }],
            xaxis: {
...
<script>
     var options = {
        series: [{
        name: 'Expense',
        data: {!! json_encode($data) !!} // Use PHP to encode the data as JSON
    }],
    xaxis: {
        categories: {!! json_encode($categories) !!} // Use PHP to encode the categories as JSON
    },
          chart: {
          height: 350,
          type: 'area'
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Overviews')}}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Total')}}</p>
                                            <h6 class="mb-3">{{__('Expenses')}}</h6>
                                            <h3 class="mb-0">{{$totExpf}} </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Total')}}</p>
                                            <h6 class="mb-3">{{__('Revenue')}}</h6>
                                            <h3 class="mb-0">{{$totRevf}} </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                            ...
                            <div class="">
                                    ...
                                    <h5 class="mt-1 mb-0">{{__('Payment Overview')}}</h5>
                                </div>
                                        <div class="card-body">
                                            <div id="chart"></div>
                                        </div>
                            ...
                            <div class="">
                                    <div class="card">
                                    <div class="card-header">
                                    <h5 class="mt-1 mb-0">{{__('Expense Overview')}}</h5>
                                </div>
                                        <div class="card-body">
                                            <div id="expchart"></div>
                                        </div>
    ...
    <div class="row mt-4">
        ...
        <div class="card-header">
            <h5 class="mt-1 mb-0">{{__('Agents')}}</h5>
        </div>
        ...
        <div class="card-body table-border-style">
            ...
            <table class="table ">
                ...
                <tbody class="table-group-divider">
                    @foreach ($aresults as $index => $result)
                        <tr>
                            <th scope="row">{{ $index + 1 }}</th>
    ...
    <div class="row mt-4">
        ...
        <div class="card-header">
            <h5 class="mt-1 mb-0">{{__('Vendors')}}</h5>
        </div>
        ...
        <div class="card-body table-border-style">
            ...
            <table class="table">
                ...
                <tbody class="table-group-divider">
                    @foreach ($vresults as $index => $result)
                        <tr>
                            <th scope="row">{{ $index + 1 }}</th>
