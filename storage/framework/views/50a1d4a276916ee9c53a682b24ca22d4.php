...
<?php $__env->startSection('content'); ?>
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit warehouse')): ?>
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center" data-url="<?php echo e(route('vendors.edit',$result->id)); ?>" data-ajax-popup="true"  data-size="lg " data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>"  data-title="<?php echo e(__('Edit ')); ?>">
    ...
    <?php echo Form::open(['method' => 'DELETE', 'route' => ['vendors.destroy', $result->id], 'id' => 'delete-form-'.$result->id]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tesla/Desktop/ERP/Test2/main-file/resources/views/vendors/pos.blade.php ENDPATH**/ ?>