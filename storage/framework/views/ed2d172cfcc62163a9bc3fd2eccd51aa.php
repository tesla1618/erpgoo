<?php echo e(Form::model($agent, array('route' => array('agents.update', $agent->id), 'method' => 'PUT' , 'enctype' => 'multipart/form-data'))); ?>
...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            <?php echo e(Form::label('agent_name', __('Name'),['class'=>'form-label'])); ?>

            <?php echo e(Form::text('agent_name', null, array('class' => 'form-control','required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('passport_number', __('Passport Number'),['class'=>'form-label'])); ?>

            <?php echo e(Form::text('passport_number', null, array('class' => 'form-control','required'=>'required'))); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::hidden('original_due', $agent->amount_due)); ?>
...
<?php /**PATH /home/tesla/Desktop/ERP/main-file/resources/views/agents/edit.blade.php ENDPATH**/ ?>