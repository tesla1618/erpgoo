<?php
    ...
    // Get data from the database based on the 'visa_type' parameter
        ...
        try {
            ...
            $agent_name = $agent_name[0]->vendor_name;
    ...
    <div class="modal-content">
      ...
      <div class="row">
                ...
                <div class="form-group">
                    ...
                    <p class="alert alert-info mt-1 mb-3">Vendor: <b><?php echo e($agent_name); ?></b></p>
                    
                    <input type="hidden" name="visa_type" value="<?php echo e($vtype); ?>">
                    <input type="hidden" name="vendor_id" value="<?php echo e($agent_id); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tesla/Desktop/ERP/Test2/main-file/resources/views/vendors/clients.blade.php ENDPATH**/ ?>