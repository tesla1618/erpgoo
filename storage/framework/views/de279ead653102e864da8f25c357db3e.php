...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item active"><?php echo e(__('Agent Ledger')); ?></li>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $ledgers->unique('agent_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ledger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <!-- If agent name show name, else show N/A -->
                                    <td><?php echo e($ledger->agent ? $ledger->agent->agent_name : 'N/A'); ?></td>
                                    
                                    <td>
                                  
    <a class="btn btn-sm align-items-center  btn-success" href="/ledger/agent?agent_id=<?php echo e($ledger->agent ? $ledger->agent->id : '0'); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('View')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tesla/Desktop/ERP/Test2/main-file/resources/views/vledger/index.blade.php ENDPATH**/ ?>