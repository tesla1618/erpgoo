                ...
                <div class="row p-3">
                    <div class="col-md-3">
                        <div class="card-header">
                            <h4 class="h4"><?php echo e(__(' Print')); ?></h4>
                        </div>
                <div class="card-body table-border-style">
                    <div class="form flex">
                        ...
                        <select class="form-control selectpicker mb-3" id="select-agent" data-live-search="true">
                            ...
                            <option value="<?php echo e($key); ?>"><?php echo e($agent); ?></option>
...
<div class="header">
    <img src="<?php echo e($logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png')); ?>"
                         alt="<?php echo e(config('app.name', 'ERPGo')); ?>" class="mb-5" width="180px">
    <div class="row">
        <div class="col-md-8">
            <h4>
            <b>
            ...
            <h4>
                <?php $__currentLoopData = $company_address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <?php echo e($address->value); ?>

                
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </h4>
                <h4>
                <?php $__currentLoopData = $company_city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <?php echo e($city->value); ?>

                
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <?php $__currentLoopData = $company_country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <?php echo e($country->value); ?>
                ...
                <h4>
                Phone: 
                <?php $__currentLoopData = $company_telephone; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $telephone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <?php echo e($telephone->value); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tesla/Desktop/ERP/Test2/main-file/resources/views/vprint/index.blade.php ENDPATH**/ ?>