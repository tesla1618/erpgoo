        ...
        <div class="navbar-content">
            <?php if(\Auth::user()->type != 'client'): ?>
                <ul class="dash-navbar">
                        ...
                        <li class="dash-item dash-hasmenu
                            ...
                            <?php if($show_dashboard == 1): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show project dashboard')): ?>
                                        <li class="dash-item <?php echo e((Request::segment(1) == null) ? ' active' : ''); ?>">
                                            <a class="dash-link" href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Overviews')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                <?php endif; ?>
                                    ...
                                    <li class="dash-item dash-hasmenu <?php echo e(( Request::segment(1) == 'report' || Request::segment(1) == 'reports-monthly-cashflow' || Request::segment(1) == 'reports-quarterly-cashflow') ? ' active dash-trigger' : ''); ?>">
                                        ...
                                        <ul class="dash-submenu">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show account dashboard')): ?>
                                                <li class="dash-item <?php echo e((  Request::segment(1) == 'account-dashboard') ? ' active' : ''); ?>">
                                                    <a class="dash-link" href="<?php echo e(route('adashboard')); ?>"><?php echo e(__(' Overview')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                ...
                                <?php if($show_dashboard == 1 && Gate::check('show account dashboard')): ?>
                                    <li class="dash-item dash-hasmenu <?php echo e(request()->fullUrl() == url('/agents/dashboard') ? 'active' : ''); ?>">
                                        <a class="dash-link" href="#"><?php echo e(__('Agents ')); ?><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show account dashboard')): ?>
                                            <li class="dash-item <?php echo e(request()->fullUrl() == url('/agents/dashboard') ? 'active' : ''); ?>">
                                        <a class="dash-link" href="/agents/dashboard"><?php echo e(__('Overview')); ?></a>
                                    </li>
                                            <?php endif; ?>
                                ...
                                <?php endif; ?>
                                <?php if($show_dashboard == 1 && Gate::check('show account dashboard')): ?>
                                    <li class="dash-item dash-hasmenu <?php echo e(request()->fullUrl() == url('/vendors/dashboard') ? 'active' : ''); ?>">
                                        <a class="dash-link" href="#"><?php echo e(__('Vendors ')); ?><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show account dashboard')): ?>
                                            <li class="dash-item <?php echo e(request()->fullUrl() == url('/vendors/dashboard') ? 'active' : ''); ?>">
                                        <a class="dash-link" href="/vendors/dashboard"><?php echo e(__('Overview')); ?></a>
                                    </li>
                                            <?php endif; ?>
                    ...
                    <?php if($show_dashboard == 1): ?>
                        <?php if( Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder') || Gate::check('manage contract')): ?>
                        <li class="dash-item dash-hasmenu<?php echo e(Str::contains(request()->url(), '/ledger/agent') ? ' active dash-trigger' : ''); ?>">
        
                        <a href="/ledger/agent" class="dash-link"
                                ><span class="dash-micon"><i class="ti ti-receipt"></i></span
                                    ><span class="dash-mtext"><?php echo e(__('Agent Ledger')); ?></span
                                    ></a>
                    ...
                    <?php if($show_dashboard == 1): ?>
                        <?php if( Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder') || Gate::check('manage contract')): ?>
                        <li class="dash-item dash-hasmenu<?php echo e(Str::contains(request()->url(), '/ledger/vendor') ? ' active dash-trigger' : ''); ?>">
        
                        <a href="/ledger/vendor" class="dash-link"
                                ><span class="dash-micon"><i class="ti ti-receipt"></i></span
                                    ><span class="dash-mtext"><?php echo e(__('Vendor Ledger')); ?></span
                                    ></a>
                    ...
                    <?php if($show_dashboard == 1): ?>
                        ...
                        <a href="/countries" class="dash-link"
                                ><span class="dash-micon"><i class="ti ti-flag"></i></span
                                    ><span class="dash-mtext"><?php echo e(__('Countries')); ?></span
                                    ></a>
                    ...
                    <?php if($show_dashboard == 1): ?>
                        <?php if( Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder') || Gate::check('manage contract')): ?>
                        <li class="dash-item dash-hasmenu<?php echo e(Str::contains(request()->url(), '/expenses') ? ' active dash-trigger' : ''); ?>">
                    ...
                    <?php if($show_dashboard == 1): ?>
                        <?php if( Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder') || Gate::check('manage contract')): ?>
                        <li class="dash-item dash-hasmenu<?php echo e(Str::contains(request()->url(), '/print') ? ' active dash-trigger' : ''); ?>">
        
                        <a href="/print" class="dash-link"
                                ><span class="dash-micon"><i class="ti ti-printer"></i></span
                                    ><span class="dash-mtext"><?php echo e(__('Print')); ?></span
                                    ></a>
                        ...
                        <?php if( Gate::check('manage warehouse') ||  Gate::check('manage purchase')  || Gate::check('manage pos') || Gate::check('manage print settings')): ?>
                            <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show')?' active dash-trigger':''); ?>">
                                ...
                                <?php endif; ?>
                                    ...
                                    <?php endif; ?>
                                    <li class="dash-item dash-hasmenu <?php echo e(request()->fullUrl() == url('/vendors/pos') ? 'active' : ''); ?>">
                                        <a class="dash-link" href="/vendors/pos"><?php echo e(__('Vendors ')); ?></a>
                                    </li>
                                    <li class="dash-item dash-hasmenu <?php echo e(request()->fullUrl() == url('/agents/pos') ? 'active' : ''); ?>">
                                    ...
                                    <!-- <li class="dash-item dash-hasmenu <?php echo e(request()->fullUrl() == url('/expenses') ? 'active' : ''); ?>">
                                        <a class="dash-link" href="/expenses"><?php echo e(__('Expenses ')); ?></a>
                                    </li> -->
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage warehouse')): ?>
...
<?php /**PATH /home/tesla/Desktop/ERP/Test2/main-file/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>